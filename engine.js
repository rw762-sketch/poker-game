...
export class Poker{
constructor(){this.players=['You','Jules','Morgan','Alex'].map(name=>({name,stack:1000,cards:[],folded:false,bet:0,total:0,action:''}));this.dealer=-1;this.hand=0;this.logs=[];this.done=true;this.board=[];this.pot=0;this.awards=[];}
