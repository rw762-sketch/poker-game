import { peerConfiguration } from './network-config.js?v=84376ad4c004';
import { TableGifts } from './table-gifts.js?v=84376ad4c004';
import { HostTable } from './room-state.js?v=84376ad4c004';
...
function loadPeer() {
  ...
  if (!loading) loading = new Promise((resolve, reject) => {
    ...
    script.src = new URL('./vendor/peerjs-1.5.5.min.js?v=84376ad4c004', import.meta.url).href;
