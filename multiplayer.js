import { peerConfiguration } from './network-config.js?v=e41832293449';
import { TableGifts } from './table-gifts.js?v=e41832293449';
import { HostTable } from './room-state.js?v=e41832293449';
...
function loadPeer() {
  ...
  if (!loading) loading = new Promise((resolve, reject) => {
    ...
    script.src = new URL('./vendor/peerjs-1.5.5.min.js?v=e41832293449', import.meta.url).href;
