import { peerConfiguration } from './network-config.js?v=e95c98b86ca5';
import { TableGifts } from './table-gifts.js?v=e95c98b86ca5';
import { HostTable } from './room-state.js?v=e95c98b86ca5';
...
function loadPeer() {
  ...
  if (!loading) loading = new Promise((resolve, reject) => {
    ...
    script.src = new URL('./vendor/peerjs-1.5.5.min.js?v=e95c98b86ca5', import.meta.url).href;
