import { peerConfiguration } from './network-config.js?v=72cf100cea79';
import { TableGifts } from './table-gifts.js?v=72cf100cea79';
import { HostTable } from './room-state.js?v=72cf100cea79';
...
function loadPeer() {
  ...
  if (!loading) loading = new Promise((resolve, reject) => {
    ...
    script.src = new URL('./vendor/peerjs-1.5.5.min.js?v=72cf100cea79', import.meta.url).href;
