import { peerConfiguration } from './network-config.js?v=637e2d377d58';
import { TableGifts } from './table-gifts.js?v=637e2d377d58';
import { HostTable } from './room-state.js?v=637e2d377d58';
...
function loadPeer() {
  ...
  if (!loading) loading = new Promise((resolve, reject) => {
    ...
    script.src = new URL('./vendor/peerjs-1.5.5.min.js?v=637e2d377d58', import.meta.url).href;
