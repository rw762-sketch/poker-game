import { peerConfiguration } from './network-config.js?v=8b385c1c879f';
import { TableGifts } from './table-gifts.js?v=8b385c1c879f';
import { HostTable } from './room-state.js?v=8b385c1c879f';
...
function loadPeer() {
  ...
  if (!loading) loading = new Promise((resolve, reject) => {
    ...
    script.src = new URL('./vendor/peerjs-1.5.5.min.js?v=8b385c1c879f', import.meta.url).href;
